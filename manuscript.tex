...
\begin{figure}[!htbp]
    ...
    \begin{minipage}[b]{0.43\textwidth}
        \centering
        \includegraphics[width=\textwidth]{plots/STI_display_ortho.png}
        \textbf{(b)} 
    \end{minipage}
    \caption{Surface water demonstration of the video footage preprocessing stage for STI generation with search lines of length of 300 px. (a) Original and (b) orthorectified.}
