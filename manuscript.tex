...
This approach enables unsupervised, automated data labeling: since the artificial flow direction is known by construction, each STI stack can be automatically assigned a ground-truth label without manual annotation. This significantly streamlines the training process and allows for large-scale generation of labeled data, which is critical for effective deep learning model development.
